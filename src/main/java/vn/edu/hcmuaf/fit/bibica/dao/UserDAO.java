    package vn.edu.hcmuaf.fit.bibica.dao;
    ...
    //    hàm này để đổi mật khẩu thông qua Email
        @SqlUpdate("UPDATE user SET password = :password WHERE email = :email")
        void changePasswordByEmail(@Bind("email") String email, @Bind("password") String password);
    }
