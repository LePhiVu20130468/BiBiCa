...
<head>
  ...
  <title><fmt:message key="productview.title.chitietsanpham" />: ${requestScope.product.name}</title>
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page">
          <a href="${pageContext.request.contextPath}/"><fmt:message key="productview.a.trangchu" /></a>
        </li>
        <li class="breadcrumb-item" aria-current="page">
    ...
    <div class="row">
      ...
      <main class="col-md-7">
        ...
        <div class="rating-wrap my-3">
          ...
          <small class="label-rating text-muted me-2">${requestScope.totalProductReviews} <fmt:message key="productview.small.danhgia" /></small>
          <small class="label-rating text-success">
            <i class="bi bi-bag-check-fill"></i> ${requestScope.product.totalBuy} <fmt:message key="productview.small.damua" />
          </small>
        </div>
        ...
        <dl class="row mb-4">
          <dt class="col-xl-4 col-sm-5 col-6"><fmt:message key="productview.dt.tacgia" /></dt>
          <dd class="col-xl-8 col-sm-7 col-6">${requestScope.product.author}</dd>

          <dt class="col-xl-4 col-sm-5 col-6"><fmt:message key="productview.dt.sotrang" /></dt>
          <dd class="col-xl-8 col-sm-7 col-6">${requestScope.product.pages}</dd>

          <dt class="col-xl-4 col-sm-5 col-6"><fmt:message key="productview.dt.nhaxuatban" /></dt>
          <dd class="col-xl-8 col-sm-7 col-6">${requestScope.product.publisher}</dd>

          <dt class="col-xl-4 col-sm-5 col-6"><fmt:message key="productview.dt.namxuatban" /></dt>
          <dd class="col-xl-8 col-sm-7 col-6">${requestScope.product.yearPublishing}</dd>

          <dt class="col-xl-4 col-sm-5 col-6"><fmt:message key="productview.dt.soluong" /></dt>
        ...
        <div>
          ...
          <button type="button" class="btn btn-primary ms-2" id="buy-now"><fmt:message key="productview.button.muangay" /></button>
          <button type="button" class="btn btn-light ms-2" id="add-cart-item"><fmt:message key="productview.button.themvaogiohang" /></button>
        </div>
...
<section class="section-content mb-4">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="pb-2"><fmt:message key="productview.h3.motasanpham" /></h3>
    ...
    <div class="row">
      <div class="col">
        <c:if test="${requestScope.totalProductReviews != 0}">
          <h3 id="review" class="pb-2">${requestScope.totalProductReviews} <fmt:message key="productview.h3.danhgia" /></h3>
              ...
              <div class="sin-rattings mb-4">
                ...
                <div>
                  <c:choose>
                    ...
                    <c:otherwise>
                      <em><fmt:message key="productview.em.noidungbianboiqtv" /></em>
                    </c:otherwise>
                  </c:choose>
                </div>
