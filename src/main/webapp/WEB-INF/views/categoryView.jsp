...
<head>
  ...
  <title>BiBiCa Shop | ${requestScope.category.name}</title>
</head>
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page">
          <a href="${pageContext.request.contextPath}/"><fmt:message key="categoryview.a.trangchu" /></a>
        </li>
        ...
        <div class="card">
          <form action="${pageContext.request.contextPath}/category" method="get">
            <article class="filter-group">
              <header class="card-header my-1">
                <a data-bs-toggle="collapse" href="#collapse_1" aria-expanded="true"
                  ...
                  <h6 class="title fw-bold"><fmt:message key="categoryview.h6.nhaxuatban" /></h6>
                </a>
              </header>
            ...
            <article class="filter-group">
              <header class="card-header my-1">
                <a data-bs-toggle="collapse" href="#collapse_2" aria-expanded="true"
                  ...
                  <i class="float-end bi bi-chevron-down"></i>
                  <h6 class="title fw-bold"><fmt:message key="categoryview.h6.giaban" /></h6>
                </a>
              </header>
                ...
                <div class="card-body pt-0">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="checkbox_price_1">
                      <fmt:message key="categoryview.label.duoi50" />
                    </label>
                  </div>
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="checkbox_price_2">
                      <fmt:message key="categoryview.label.tu50den200" />
                    </label>
                  </div>
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="checkbox_price_3">
                      <fmt:message key="categoryview.label.tren200" />
                    </label>
                  </div>
                </div> <!-- card-body.// -->
              </div>
            ...
            <article class="filter-group">
              <header class="card-header my-1">
                <a data-bs-toggle="collapse" href="#collapse_3" aria-expanded="true"
                  ...
                  <i class="float-end bi bi-chevron-down"></i>
                  <h6 class="title fw-bold"><fmt:message key="categoryview.h6.sapxeptheo" /></h6>
                </a>
              </header>
                ...
                <div class="card-body pt-0">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="radio_order_1">
                      <fmt:message key="categoryview.label.banchaynhat" />
                    </label>
                  </div>
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="radio_order_2">
                      <fmt:message key="categoryview.label.moinhat" />
                    </label>
                  </div>
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="radio_order_3">
                      <fmt:message key="categoryview.label.giathapnhat" />
                    </label>
                  </div>
                </div> <!-- card-body.// -->
              </div>
            ...
            <article class="card-body">
              <button type="submit" class="btn btn-primary w-100"><fmt:message key="categoryview.button.loc" /></button>
            </article>
          </form>
        </div> <!-- card.// -->
      </aside> <!-- col.// -->
      ...
      <main class="col-md-8 col-lg-9">
        ...
        <header class="border-bottom mb-4 pb-3">
          <div class="form-inline d-flex justify-content-between align-items-center">
            <span>${requestScope.totalProducts} <fmt:message key="categoryview.span.sanpham" /></span>
          </div>
        </header> <!-- sect-heading -->
            ...
            <ul class="pagination">
              <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
                <a class="page-link"
                  ...
                  <fmt:message key="categoryview.a.trangtruoc" />
                </a>
              </li>
              ...
              <li class="page-item ${requestScope.page == requestScope.totalPages ? 'disabled' : ''}">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/category?id=${requestScope.category.id}&page=${requestScope.page + 1}${requestScope.filterQueryString}">
                  <fmt:message key="categoryview.a.trangsau" />
                </a>
              </li>
            </ul>
          </nav>
