...
<head>
  ...
  <title><fmt:message key="searchview.title.ketquatimkiemcho" />: "${requestScope.query}"</title>
</head>
  ...
  <div class="container">
    <header class="section-heading py-4">
      <h3 class="section-title">
        <fmt:message key="searchview.h3.ketquatimkiemcho" /> "${requestScope.query}": ${requestScope.totalProducts} <fmt:message key="searchview.h3.sanpham" />
      </h3>
        ...
        <ul class="pagination">
          <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
            <a class="page-link"
              ...
              <fmt:message key="searchview.a.trangtruoc" />
            </a>
          </li>
          ...
          <li class="page-item ${requestScope.page == requestScope.totalPages ? 'disabled' : ''}">
            <a class="page-link"
               href="${pageContext.request.contextPath}/search?q=${requestScope.query}&page=${requestScope.page + 1}">
              <fmt:message key="searchview.a.trangsau" />
            </a>
          </li>
        </ul>
      </nav>
